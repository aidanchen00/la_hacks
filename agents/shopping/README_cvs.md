# CareFlow CVS Shopping Agent

Searches CVS.com for pharmacy products matching a wellness query within an allocated budget.

## What This Agent Does

Receives a `BudgetAllocation` from the CareFlow Budget Agent, uses BrowserUse to search CVS.com for the best matching product under the allocated price, and returns a `ShoppingResult` with the item name, price, URL, and stock status.
