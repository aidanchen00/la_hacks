# CareFlow GoodRx Shopping Agent
...
Receives a `BudgetAllocation` from the CareFlow Budget Agent, uses BrowserUse to search GoodRx.com for the best matching product or coupon under the allocated price, and returns a `ShoppingResult` with the item name, price, URL, and stock status.
